...
namespace OpenLogReplicator {
    ...
    protected:
        ...
        void updateDatabaseIncarnation();

        virtual std::string sqlGetSequenceFromScn();
        virtual std::string sqlGetArchiveLogList();
        virtual std::string sqlGetDatabaseInformation();
        virtual std::string sqlGetDatabaseIncarnation();
        virtual std::string sqlGetDatabaseRole();
        virtual std::string sqlGetDatabaseScn();
        virtual std::string sqlGetSequenceFromScnStandby();
        virtual std::string sqlGetLogfileList();
        virtual std::string sqlGetParameter() const;
